...
<div class="card">
    ...
    <div class="">
        <a href="{{ route('brand-create') }}" class="btn btn-success" style="float: right; margin-top: -51px; margin-right: 41px;">Add Brand</a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('brand-delete',['id'=>$brand->id])}}" onclick="confirmation(event)" style="margin-right: 10px;"><i class="bi bi-trash" style="color: red;font-size:20px"></i></a>
                            <a href="{{route('brand-edit',['id'=>$brand->id])}}"><i class="bi-pencil-square" style="color: green;font-size:20px"></i></a>
                        </div>
                        </td> 
                    </tr>
                    @endforeach
